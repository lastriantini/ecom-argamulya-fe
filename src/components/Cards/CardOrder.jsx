  ...
  return (
    <div className="grid grid-cols-12 mx-[2.6vw] pt-[1vw] pb-[0.2vw] px-[2.1vw] text-[#422D1C] arya-regular text-[1.4vw] my-[1.3vw] bg-[#422D1C] bg-opacity-[0.2] rounded-[1vw]">
      <div className="col-span-2">
        <img src={profile_pic} alt={profile_pic} className="rounded-[0.5vw] w-[9vw] h-[8vw] mt-[0.5vw] ml-[-0.5vw] mb-[1.5vw]" />
      </div>
      <div key={index} className="mb-4 col-span-10">
        <Typography className="arya-bold text-[1vw] text-white rounded-full">
